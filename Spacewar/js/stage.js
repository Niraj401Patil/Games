function stage(lvl,context1,compSize,img_ship,img_obstacle){
    ...
    this.ships.push(new ship(context1.width,context1.height/2,compSize*4,compSize*3,context1,30,img_ship));
...
//*****************************************obstacles******************************************************** */
    this.addObstacles=function(move){
        ...
        this.obstacles.push(new obstacle(context1.width,Math.random()*(context1.height-50)+20,compSize*2,compSize*2,context1,move,img()));
    };
//*************************************************************************************************************************************  
