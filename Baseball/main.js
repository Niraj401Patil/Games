...
function play(level, context1) {
  ...
  // canvas.addEventListener("mouseout",stopGame);
  // canvas.addEventListener("mouseenter",starGame);
  ...
  function gameEnd() {
    // let btnReplay=new button(0-context1.width,context1.height/4,context1.width*2,context1.height/8,"Game Over! Play Again","rgb(0,0,0)","white");
    //btnReplay.drawButton(context1.ctx);
    stopGame();
